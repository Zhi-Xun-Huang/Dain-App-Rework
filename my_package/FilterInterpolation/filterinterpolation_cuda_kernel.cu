...
FilterInterpolationLayer_gpu_forward_kernelfunc<<<grid,block,0, stream >>>(
			...
			input1.data_ptr<scalar_t>(),input2.data_ptr<scalar_t>(),input3.data_ptr<scalar_t>(), output.data_ptr<scalar_t>()
			);
 					}));
...
FilterInterpolationLayer_gpu_backward_kernelfunc <<<grid,block,0, stream>>>(
			...
			input1.data_ptr<scalar_t>(), 			input2.data_ptr<scalar_t>(),         input3.data_ptr<scalar_t>(),  			gradoutput.data_ptr<scalar_t>(),
			gradinput1.data_ptr<scalar_t>(), 			gradinput2.data_ptr<scalar_t>(),     gradinput3.data_ptr<scalar_t>()
			);
 					}));
