...
//    printf("I am here\n");
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.scalar_type(), "DepthFlowProjection_gpu_forward", ([&] {
    ...
    DepthFlowProjection_gpu_forward_kernelfunc<<<grid,block,0, stream >>>(
            ...
            input1.data_ptr<scalar_t>(),input2.data_ptr<scalar_t>(),count.data_ptr<scalar_t>(),output.data_ptr<scalar_t>()
            );
...
//    printf("I am there\n");
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.scalar_type(), "DepthFlowProjectionAveraging", ([&] {
...
//        printf("use flow fill hole\n");
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.scalar_type(), "DepthFlowFillhole", ([&] {
        ...
        )
{
    ...
    if(BLOCKDIMX != 32 || BLOCKDIMY != 16||DEBUG)
        printf("BLOCKDIMX revised to %d, BLOCKDIMY revised to %d \n", BLOCKDIMX,BLOCKDIMY);
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.scalar_type(), "DepthFlowProjection_gpu_backward", ([&] {
    ...
    DepthFlowProjection_gpu_backward_kernelfunc <<<grid,block,0, stream>>>(
            ...
            input1.data_ptr<scalar_t>(),input2.data_ptr<scalar_t>(),count.data_ptr<scalar_t>(),output.data_ptr<scalar_t>(),
            gradoutput.data_ptr<scalar_t>(), gradinput1.data_ptr<scalar_t>(), gradinput2.data_ptr<scalar_t>()
            );
                    }));
